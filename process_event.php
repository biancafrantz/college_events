...
if (!empty($roomNumber)) {
    ...
    // Get Admin ID from Users table (check if they are of type Admin)
    ...
    if ($eventStmt->execute()) {
        ...
        echo "<script>
            alert('Error inserting into Events table. This may be due to overlapping events or bad data.');
            window.history.back();
        </script>";
        exit;
    }
